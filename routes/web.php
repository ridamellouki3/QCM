...
|
*/
Route::get('/',[EtudiantController::class,'index'])->name('HomeUser');
Route::middleware('Guest')->group(function(){
    ...
    Route::get('/LoginForm',[EtudiantController::class,'loginForm'])->name('LoginForm');
...
Route::middleware('Admin')->group(function(){
    ...
    Route::get('/Admin',[Professeur_controller::class,'index'])->name('Home');
...
Route::middleware('Etudiant')->group(function (){
    ...
    Route::get('/startQuiz/{Qcm}',[EtudiantController::class,'startQuiz'])->name('startQuiz');
    Route::get('/nextQuestion/{id}',[EtudiantController::class,'startQuiz'])->name('Shownext');
    Route::post('/showQuestion/{id}',[EtudiantController::class,'showQuestion'])->name('next');
});
